...
class cellTeapot : public App
{
    ...
    virtual void setup()
    {
        ...
        GLuint shaders[2];
        shaders[0] = shader::fromFile("../shaders/cell/cell.vert", GL_VERTEX_SHADER, true);
        shaders[1] = shader::fromFile("../shaders/cell/cell.frag", GL_FRAGMENT_SHADER, true);
